...
export default function AboutMeSection() {
  ...
  const skills = [
    { name: 'Frontend', level: 90, color: '#FF5733' },
    { name: 'Backend', level: 85, color: '#3A86FF' },
    { name: 'UI/UX', level: 80, color: '#FF5733' },
    { name: 'Mobile', level: 75, color: '#3A86FF' },
    { name: 'DevOps', level: 70, color: '#FF5733' },
  ];

  const stats = [
    { value: '5+', label: 'Años de experiencia', icon: '💼' },
    { value: '20+', label: 'Proyectos completados', icon: '🚀' },
    { value: '15+', label: 'Clientes satisfechos', icon: '🤝' },
    { value: '3+', label: 'Premios recibidos', icon: '🏆' },
  ];
          ...
          <div className="relative reveal-from-left" ref={imageRef}>
            <div className="relative w-full max-w-md mx-auto aspect-square rounded-3xl overflow-hidden border border-white/10">
              ...
              <div className="absolute bottom-8 left-1/2 -translate-x-1/2 w-[85%] p-5 backdrop-blur-md bg-black/40 border border-white/10 rounded-xl">
                <h3 className="text-xl font-bold mb-2">Juan Pérez</h3>
                <p className="text-[#3A86FF] font-medium mb-3">Desarrollador Full-Stack</p>
            ...
            <div ref={bioRef}>
              ...
              <div className="space-y-5 text-gray-300">
                <p>
                  ...
                  en creación de soluciones digitales innovadoras. Mi pasión es convertir ideas 
                  complejas en aplicaciones elegantes y funcionales que resuelvan problemas reales.
                </p>
                <p>
                  Me especializo en tecnologías web modernas como React, Next.js y Node.js, 
                  con especial atención al diseño de interfaces intuitivas y accesibles. 
                  Mi enfoque combina creatividad técnica con una perspectiva centrada en el usuario.
                </p>
                <p>
                  A lo largo de mi carrera, he colaborado con startups, agencias y grandes empresas, 
                  lo que me ha permitido desarrollar una perspectiva amplia sobre distintos modelos 
                  de negocio y necesidades digitales.
                </p>
              </div>
